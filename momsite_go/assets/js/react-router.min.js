!function(e, t) {
    ...
    return function(e) {
        ...
        var i = n(39), s = r(i), c = n(20), f = r(c), l = n(33), d = r(l), p = n(52), h = r(p), v = n(34), y = r(v), m = n(35), g = r(m), _ = n(21), R = r(_), O = n(37), b = r(O), P = n(32), w = r(P), M = n(36), x = r(M), j = n(38), E = r(j), S = n(51), A = r(S), C = n(10), k = r(C), T = n(40), H = r(T), q = r(u), L = n(49), U = r(L), N = n(26), B = r(N), I = n(42), W = r(I), D = n(43), F = r(D), Q = n(47), K = r(Q), V = n(23), $ = r(V);
        ...
        function f(e, t) {
            t = t || {};
            for (var n = a(e), r = n.tokens, o = 0, u = "", i = 0, s = void 0, c = void 0, f = void 0, l = 0, p = r.length; l < p; ++l)
            ...
            render: function() {
                ...
                return f && (l = f.reduceRight(function(t, i, c) {
                    ...
                    if ("object" === ("undefined" == typeof i ? "undefined" : o(i))) {
                        var y = {};
                        for (var m in i)
                            Object.prototype.hasOwnProperty.call(i, m) && (y[m] = e.createElement(i[m], u({
                                key: m
                            }, h)));
                        return y
                    }
        ...
        function u(e, t) {
            ...
            function h(e, n) {
                (0, m["default"])(t, e, function(t, r) {
                    ...
                    for (var o = d((0, f["default"])(O, b).leaveRoutes), u = void 0, i = 0, s = o.length; null == u && i < s; ++i)
                        u = o[i](e);
                    n(u)
                })
            }
            ...
            function g(e) {
                var t = c(e, !1);
                t && (delete w[t], o(w) || (M && (M(), M = null), x && (x(), x = null)))
            }
            function _(t, n) {
                var r = c(t), u = w[r];
                if (u)
                    ...
                    var a=!o(w);
                    w[r] = [n], a && (M = e.listenBefore(h), e.listenBeforeUnload && (x = e.listenBeforeUnload(y)))
                }
                return function() {
                    var e = w[r];
                    if (e) {
            ...
            var O = {}, b = void 0, P = 1, w = Object.create(null), M = void 0, x = void 0;
            return {
                isActive: n,
                match: u,
        ...
        function a() {
            ...
            function n(e) {
                var n = t();
                W = e, W.action === p.PUSH ? B = [].concat(B.slice(0, n + 1), [W.key]) : W.action === p.REPLACE && (B[n] = W.key), I.forEach(function(e) {
                    e(W)
                })
            }
            function r(e) {
                ...
                W && u(W, e) || (D = e, a(e, function(t) {
                    if (D === e)
                        if (t) {
                            if (e.action === p.PUSH) {
                                var r = b(W), o = b(e);
                                o === r && f["default"](W.state, e.state) && (e.action = p.REPLACE)
                            }
                            T(e)!==!1 && n(e)
                        } else if (W && e.action === p.POP) {
                            var u = B.indexOf(W.key), a = B.indexOf(e.key);
                            u!==-1 && a!==-1 && q(u - a)
                        }
                    }))
            }
            ...
            return {
                ...
                createHref: P,
                createLocation: w,
                setState: _["default"](M, "setState is deprecated; use location.key to save state instead"),
        ...
        var i = Object.assign || function(e) {
            ...
            return e
        }, s = n(29), c = r(s), f = n(13), l = r(f), d = n(3), p = r(d), h = n(2), v = r(h), y = n(16), m = r(y), g = n(6), _ = n(10), R = r(_), O = n(5), b = n(22), P = n(1), w = (r(P), v["default"].PropTypes), M = w.func, x = w.object, j = v["default"].createClass({
            displayName: "Router",
            propTypes: {
                history: x,
                children: g.routes,
        ...
        var o = Object.assign || function(e) {
            ...
            return e
        }, u = n(2), a = r(u), i = n(10), s = r(i), c = n(1);
        r(c);
        t["default"] = function() {
        ...
        function u(e, t, n) {
            for (var r = e, o = [], u = [], a = 0, i = t.length; a < i; ++a) {
                ...
                if ("/" === f.charAt(0) && (r = e, o = [], u = []), null !== r && f) {
                    ...
                    if (l ? (r = l.remainingPathname, o = [].concat(o, l.paramNames), u = [].concat(u, l.paramValues)) : r = null, "" === r)
        ...
        function s(e, t, n, r, a, s) {
            ...
            if ("/" === f.charAt(0) && (n = t.pathname, r = [], a = []), null !== n && f) {
                ...
                if ("" === n) {
                    ...
                    if ("object" === ("undefined" == typeof h ? "undefined" : l(h)))
                        return h.v
                }
            }
        ...
        function c(e, t, n, r) {
            ...
            void 0 === r && ("/" !== t.pathname.charAt(0) && (t = f({}, t, {
                pathname: "/" + t.pathname
            })), r = t.pathname), (0, d.loopAsync)(e.length, function(n, a, i) {
        ...
        function u(e, t) {
            var n = t && t.withRef, r = f["default"].createClass({
                ...
                render: function() {
                    var t = this, r = this.props.router || this.context.router, o = a({}, this.props, {
                        router: r
                    });
        ...
        t["default"] = u;
        var i = n(3), s = r(i), c = n(2), f = r(c), l = n(60), d = r(l), p = n(15)
    }, function(e, t, n) {
        function r(e) {
        ...
        function u(e, t, n) {
            ...
            if (e.prototype !== t.prototype)
                return !1;
            if (s(e))
                return !!s(t) && (e = a.call(e), t = a.call(t), c(e, t, n));
            if (o(e)) {
                if (!o(t))
                    return !1;
        ...
        function o() {
            function e(e) {
                ...
                o ? a = d.readState(o) : (a = null, o = _.createKey(), m && window.history.replaceState(u({}, e, {
                    key: o
                }), null));
                var i = c.parsePath(n);
                return _.createLocation(u({}, i, {
                    state: a
                }), void 0, o)
            }
            function t(t) {
            ...
            function n(e) {
                ...
                if (a !== s.POP) {
                    ...
                    if (a === s.PUSH) {
                        ...
                        if (g)
                            return window.location.replace(c), !1;
